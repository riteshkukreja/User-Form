...
public class UserController {
    ...
    @PostMapping("user")
    public String createUser(@ModelAttribute("user") User user, BindingResult result, Model model) throws Exception {
        int id = userService.create(user);
        return "redirect:/user/" + id;
    }
    
    @PostMapping("user/{userId}")
    public String updateUser(@PathVariable int userId, @ModelAttribute("user") User user, BindingResult result, Model model) throws Exception {
